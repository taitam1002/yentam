    ...
    <section id="videos" className="py-20 bg-background relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16 animate-slide-up">
          <h2 className="text-3xl md:text-4xl font-bold text-primary dark:text-accent mb-4">Video Giới Thiệu</h2>
          <p className="text-lg text-foreground/80 max-w-2xl mx-auto text-justify">
