...
export default function CommitmentStory() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-card/40 via-background to-card/30 py-24 md:py-32">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[800px] bg-accent/5 rounded-full blur-3xl animate-float"></div>
      </div>
      <SparkleBackground />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {commitments.map((item, index) => (
            <div
              key={index}
              className="group relative rounded-2xl border-2 border-accent/30 dark:border-accent/20 bg-gradient-to-br from-card/80 via-card/60 to-background/40 p-8 text-center backdrop-blur-lg shadow-sm transition-all duration-500 hover:border-accent/60 hover:shadow-2xl hover:shadow-accent/20 hover:-translate-y-2 animate-scale-in"
        ...
        {/* CTA Section */}
        <div className="relative rounded-3xl border-2 border-accent/30 bg-gradient-to-br from-card/80 via-card/60 to-background/40 p-12 md:p-16 text-center backdrop-blur-lg shadow-2xl overflow-hidden animate-scale-in" style={{ animationDelay: "0.5s" }}>
          ...
          <div className="relative space-y-6">
            ...
            <div className="flex flex-wrap justify-center gap-4 pt-4">
              ...
              <Link
                href="/menu"
                className="group relative overflow-hidden rounded-xl border-2 border-accent/50 bg-card/50 px-8 py-4 font-semibold text-accent backdrop-blur transition-all duration-500 hover:border-accent hover:bg-accent/10 hover:scale-105"
              >
